...
copy *.y %tempdir%\Source
copy *.l %tempdir%\Source
copy makefile* %tempdir%\Source

rem Copy the binary files
copy Release\sheepc.exe %tempdir%
copy Release\sheep.dll %tempdir%
copy Release\sheep.lib %tempdir%
copy *.txt %tempdir%


rem Zip up the temporary directory
%zip% a Sheep.zip %tempdir%\*
